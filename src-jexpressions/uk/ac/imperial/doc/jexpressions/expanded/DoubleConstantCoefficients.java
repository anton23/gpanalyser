...
public class DoubleConstantCoefficients implements ICoefficientSpecification {

	@Override
	public boolean isCoefficient(AbstractExpression e) {
		/*
		 * ContractingExpressionTransformer t = new
		 * ContractingExpressionTransformer(); e.accept(t); e = t.getResult();
		 */
