//from package org.jzy3d.demos.multiview2;
...
public class ViewMouseControllerSwing extends ViewCameraController implements
                MouseListener, MouseMotionListener, MouseWheelListener {
        public ViewMouseControllerSwing() {
                super();
        }

        public ViewMouseControllerSwing(View view) {
                super();
                addTarget(view);
        }

        public void addMouseSource(CanvasSwing canvas) {
                this.canvas = canvas;
