...
public class CombinedProductExpression extends AbstractExpression {
	...
	public static AbstractExpression createMeanExpression(State state) {
		return CombinedProductExpression.create(CombinedPopulationProduct
				.getMeanPopulation(state));
	}
	...
	public void accept(IExpressionVisitor v) {
		if (v instanceof ICombinedProductExpressionVisitor) {
			...
			throw new AssertionError(
					"Not supported visit for a Combined moment expression!");
		}
	}
	...
	public boolean equals(Object o) {
		if (this == o)
			return true;
		if (!(o instanceof CombinedProductExpression))
			return false;
