...
public abstract class AggregatedStateNextEventGenerator {
	...
	public abstract void recalculateWeights(double[] counts, double t); // responsible for
	// calculating the total weight as well

	public double nextStep(double[] counts, double t) {
		recalculateWeights(counts, t);
		if (totalRate == 0.0)
			return -1;
