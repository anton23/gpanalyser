...
{
	public MASSPACompilerWSNSynchTest() throws ParseException
	{
		super("test-masspa-inputs/wsn/wsn_sync.masspa");
	}
	...
	public void testPCTMC()
	{
		...
		// Evo's @(0)
		evolutionEventsExpected.add(new EvolutionEvent(Lists.newArrayList(getPop("Off","0"),getPop("On","1")), Lists.newArrayList(getPop("#turn_on","0"),getPop("#turn_on","A"),getPop("#turn_off","1"),getPop("#turn_off","A"),getPop("On","0"),getPop("Off","1")),
				ProductExpression.create(MinExpression.create(CombinedProductExpression.create(CombinedPopulationProduct.getMeanPopulation(getPop("Off","0"))), CombinedProductExpression.create(CombinedPopulationProduct.getMeanPopulation(getPop("On","1")))),new DoubleExpression(0.15/300.0))));
		...
		// Evo's @(2)
		evolutionEventsExpected.add(new EvolutionEvent(Lists.newArrayList(getPop("Off","2"),getPop("On","1")), Lists.newArrayList(getPop("#turn_on","2"),getPop("#turn_on","A"),getPop("#turn_off","1"),getPop("#turn_off","A"),getPop("On","2"),getPop("Off","1")),
				ProductExpression.create(MinExpression.create(CombinedProductExpression.create(CombinedPopulationProduct.getMeanPopulation(getPop("Off","2"))), CombinedProductExpression.create(CombinedPopulationProduct.getMeanPopulation(getPop("On","1")))),new DoubleExpression(0.15/450.0))));
		...
		// Evo's @(1)
		evolutionEventsExpected.add(new EvolutionEvent(Lists.newArrayList(getPop("Off","1"),getPop("On","0")), Lists.newArrayList(getPop("#turn_on","1"),getPop("#turn_on","A"),getPop("#turn_off","0"),getPop("#turn_off","A"),getPop("On","1"),getPop("Off","0")),
				ProductExpression.create(MinExpression.create(CombinedProductExpression.create(CombinedPopulationProduct.getMeanPopulation(getPop("Off","1"))), CombinedProductExpression.create(CombinedPopulationProduct.getMeanPopulation(getPop("On","0")))),new DoubleExpression(0.10/300.0))));
		evolutionEventsExpected.add(new EvolutionEvent(Lists.newArrayList(getPop("Off","1"),getPop("On","2")), Lists.newArrayList(getPop("#turn_on","1"),getPop("#turn_on","A"),getPop("#turn_off","2"),getPop("#turn_off","A"),getPop("On","1"),getPop("Off","2")),
				ProductExpression.create(MinExpression.create(CombinedProductExpression.create(CombinedPopulationProduct.getMeanPopulation(getPop("Off","1"))), CombinedProductExpression.create(CombinedPopulationProduct.getMeanPopulation(getPop("On","2")))),new DoubleExpression(0.10/300.0))));
